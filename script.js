...
//     const displayAccurracy = document.getElementById("accuracy-display")
...
//             // li.addEventListener('click',selectedAnswer) // You can not pass parameter, for not immediately invokated function
//             li.addEventListener('click',() => selectedAnswer(choice)) // other choice , run later but argument passed
...
//         displayScore.textContent= `${score} out of ${quizData.length}`
//         displayAccurracy.textContent = `Accurancy : ${score/quizData.length}`
//     }
